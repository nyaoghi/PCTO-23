...
<head>
  ...
  <center>
   ...
   <div class="col-md-4">
      ...
      <label for="inputPassword5" class="form-label">Indirizzo di residenza</label>
            <input type="password" id="inputPassword5" class="form-control" aria-describedby="passwordHelpBlock">
				<label for="validationCustom04" class="form-label">Password </label>
				<input type=text name="passwordlog" class="form-control" id="validationCustom04" required />
			</div>
